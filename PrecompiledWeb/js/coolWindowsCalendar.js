...
document.writeln('<iframe id=meizzDateLayer Author=wayx frameborder=0 style="position: absolute; width: 145; height: 255; z-index: 9998; display: none"></iframe>'); 
strFrame='<style>'; 
...
outObject.realValue= yy + "-" + mm + "-" + n ;//与别一个JS文件接应  // 囨囚囨図添加 //
closeLayer(); 
} 
