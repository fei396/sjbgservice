<%@ page language="C#" autoeventwireup="true" inherits="editfile_detail, App_Web_10opxpjw" %>
...
<body style="background-color: #F7Feff" align="center">
   ...
   <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="DutyRoom" HeaderText="指导室" SortExpression="DutyRoom" />
