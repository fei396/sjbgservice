            ...
            <tr>
                ...
                <td id="left" class="left_border">
                    <div id="left_toolbar" class="toolbarBg">
                        ...
                        <a href="logout.aspx" onclick="return confirm('确认退出系统？');">退出系统</a>
                    </div>
                    <!-- 左侧导航菜单开始 -->
                    <div id="menuWarp">
                ...
                <td id="main" class="main_border">
                    <div id="main_toolbar" class="toolbarBg">
                        ...
                        <a href="javascript:void(0);" onclick="goTo(this);" rel="showLeft" id="btnShowLeft" class="sh_left_open" title="隐藏左侧导航菜单">
                            <span class="btnIco btnShLeft"></span><span id="manage_title">系统管理员</span></a>
                    </div>
                    <iframe src="" id="main_data" name="main_data" marginwidth="0" marginheight="0" frameborder="0" scrolling="no" onload="reSize();"></iframe>
                    <div id="footer" class="toolbarBg">
                        <span class="left"> 2011版权所有.</span></div>
                </td>
            </tr>
        </table>
    </div>
