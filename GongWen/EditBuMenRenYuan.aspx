<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditBuMenRenYuan.aspx.cs" Inherits="EditBuMenRenYuan" %>
    ...
    <form id="form1" runat="server" align="center">
        ...
        <table align="center" width="50%">
            <tr>
                ...
                <td align="left" valign="middle" width="20%">工号：</td>
                <td width="30%">
        ...
        <div align="center">
            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" DataKeyNames="GongHao"
                BorderStyle="Solid" BorderWidth="2px" CaptionAlign="Right" CellPadding="4"
                ForeColor="#333333" Width="50%"  OnRowDeleting="gvList_RowDeleting">
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataField="XianShiMingCheng" HeaderText="姓名" />
