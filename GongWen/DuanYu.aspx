<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DuanYu.aspx.cs" Inherits="DuanYu" %>
    ...
    <form id="form1" runat="server" align="center">
        ...
        <table align="center" width="50%">
            <tr>
                ...
                <td align="left" valign="middle" width="20%">短语：</td>
                <td width="30%">
                    <asp:TextBox ID="txtDuanYu" runat="server" Width="90%"></asp:TextBox>
                </td>
        ...
        <div align="center">
            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DuanYuNeiRong" HeaderText="短语内容" />
