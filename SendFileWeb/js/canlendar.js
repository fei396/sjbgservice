...
var todayString = "今天是"
var weekString = "星期"
var scrollLeftMessage = "到上月"
var scrollRightMessage = "到下月"
var selectMonthMessage = "选择月"
var selectYearMessage = "选择年"
var selectDateMessage = "Select [date] as date." // do not replace [date], it will be replaced by date.
var titlebg="#90BAED";
var weekbg="#f0f0f0";
var titleborder="#3366FF";
var todaybg="#C9DBF7";
...
document.write ("<div onclick='bShow=true' id='calendar' style='z-index:+999;position:absolute;visibility:hidden;'><table width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:verdana; font-size:11px}' bgcolor='#ffffff'><tr bgcolor='"+titlebg+"'><td><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#ffffff'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' WIDTH='11' HEIGHT='10' BORDER='0' ALT='关闭'></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content'></span></td></tr>")

if (showToday==1)
{
document.write ("<tr bgcolor="+todaybg+"><td style='padding:5px' align=center><span id='lblToday'></span></td></tr>")
}
...
sHTML = "<table border=0 style='font-family:Arial;font-size:10px;' bgcolor='"+weekbg+"'><tr>"
...
document.getElementById("spanMonth").innerHTML = "&nbsp;" + monthName[monthSelected] + "&nbsp;<IMG id='changeMonth' SRC='"+imgDir+"drop1.gif' WIDTH='11' HEIGHT='10' BORDER=0>"
document.getElementById("spanYear").innerHTML = "&nbsp;" + yearSelected + "&nbsp;<IMG id='changeYear' SRC='"+imgDir+"drop1.gif' WIDTH='11' HEIGHT='10' BORDER=0>"
}
