...
init = function(adm) {
	...
	{
		Menus = {
	    "管理员操作" :	{"row" : 1, "show" : true, "menu" : {"添加管理员" : "glytj.aspx", "编辑管理员" : "glybj.aspx"}},
	    "卡控项目" :	{"row" : 1, "show" : true, "menu" : {"添加卡控项目" : "kkxmtj.aspx", "编辑卡控项目" : "kkxmbj.aspx"}},
	    "详细信息" :	{"row" : 1, "show" : true, "menu" : {"人员信息导入" : "ryxxdr.aspx", "人员信息编辑" : "ryxxbj.aspx"}},
		"统计查询" :	{"row" : 1, "show" : true, "menu" : {"汇总查询" : "hzcx.aspx" ,"明细查询" : "mxcx.aspx","个人查询" : "grcx.aspx","个人卡控查询" : "kkjlcx.aspx","卡控记录汇总" : "kkhzcx.aspx","卡控明细查询" : "kkmxcx.aspx","卡控项目汇总":"kkjlxmhz.aspx","不合格人员查询":"wdrmxcx.aspx"}},
		"基本操作" :	{"row" : 1, "show" : true, "menu" : {"修改密码" : "xgmm.aspx"}}
    ...
    Menus = {
	    ...
	    "卡控项目" :	{"row" : 1, "show" : true, "menu" : {"确认卡控项目" : "pbkkxmbj.aspx","有效卡控项目" : "pbkkxmyx.aspx","无效卡控项目" : "pbkkxmwx.aspx"}},
		"统计查询" :	{"row" : 1, "show" : true, "menu" : {"汇总查询" : "hzcx.aspx" ,"明细查询" : "mxcx.aspx","个人查询" : "grcx.aspx","个人卡控查询" : "kkjlcx.aspx","卡控记录汇总" : "kkhzcx.aspx","卡控明细查询" : "kkmxcx.aspx","卡控项目汇总":"kkjlxmhz.aspx","不合格人员查询":"wdrmxcx.aspx"}},
		"基本操作" :	{"row" : 1, "show" : true, "menu" : {"修改密码" : "xgmm.aspx"}}
...
goTo = function(e){
	...
	switch(eRel){
		...
		case "home" :
			...
			menu.moduleMenu(null, 'btnHome');
			$("manage_title").innerHTML = "派班安全卡控系统";
			$("manage_menu").innerHTML="派班安全卡控系统";
			break;
	    case "default" :
			goUrl("");
			menu.moduleMenu(null, 'btnHome');
