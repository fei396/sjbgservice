<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DustibnMail.aspx.cs" Inherits="AjaxMail.DustibnMail" StylesheetTheme="Web2ASPNET2" %>
    ...
    <asp:UpdatePanel ID="upForm" runat="server" UpdateMode="Always" RenderMode="Block">
		<ContentTemplate>
			<table class="Table" width="100%" cellpadding="2" cellspacing="0" border="1" bordercolor="#daeeee">
				<tr>
					<td>垃圾<span style="color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans-serif; font-size: 12px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-stroke-width: 0px; display: inline !important; float: none; background-color: rgb(255, 255, 247);">箱&nbsp;&nbsp;&nbsp; 
                        共<asp:Label ID="yjzslbl" runat="server" Text="Label"></asp:Label>
                        封邮件&nbsp;&nbsp;&nbsp;</span></td>
				</tr>	
				<tr>
					<td>
						<asp:GridView ID="gvMailbox" runat="server" AutoGenerateColumns="False" 
							...
							<Columns>
								...
								<asp:TemplateField ItemStyle-Width="35%" ItemStyle-HorizontalAlign="center" HeaderText="主题">
									<ItemTemplate>
										<a href='ReadMail.aspx?fromym=dustibnmail&MailID=<%#Eval("ID") %>'><%# Eval("title")%></a> 
									</ItemTemplate>
